                  ...
                  <div className="payment-card">
                    <div className="header">
                      <div className="intro-text">
                        ...
                        помогает лучше понять рынок, развить навыки и увеличить
                        доход
                      </div>
